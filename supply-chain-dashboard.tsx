...
const SupplyChainDashboard = () => {
  ...
  const TabButton = ({ tab, label, isActive, onClick }) => (
    <button
      onClick={() => onClick(tab)}
      className={`px-8 py-4 font-medium rounded-xl transition-all duration-300 transform hover:scale-105 tracking-wide ${
        isActive
          ? "bg-gradient-to-r from-red-600 to-red-700 text-white shadow-2xl shadow-red-500/25 font-semibold"
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className="text-gray-300 text-lg mt-1 font-light"
                style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}
              >
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={priceData}>
                    ...
                    <XAxis
                      ...
                      style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}
                    />
                    <YAxis stroke="#9CA3AF" style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }} />
                    <Tooltip
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={demandData}>
                    ...
                    <XAxis dataKey="region" style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }} />
                    <YAxis style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }} />
                    <Tooltip contentStyle={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full" style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
                  <thead>
                      ...
                      <tr key={index} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          <div className="flex items-center">
                            <span className="font-semibold mr-2">{supplier.score}</span>
                        ...
                        <td className="py-3 px-4">{supplier.quality}</td>
                        <td className="py-3 px-4">{supplier.delivery}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      <div className="border-t border-gray-800 bg-black/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-center">
            <p className="text-gray-400 text-sm" style={{ fontFamily: "Inter, system-ui, -apple-system, sans-serif" }}>
              Built with ❤️ by <span className="font-semibold text-red-400">Kshitiz</span> • AI Engineer
            </p>
          </div>
        </div>
      </div>
